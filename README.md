School Bright web application (Angular)
...
2. Install NPM packages for schoolBright-app-angular project's dependencies in order to start the project use:
```bash
$ cd schoolBright-app-angular
...
`schoolBright-app-angular` provides the following features:
